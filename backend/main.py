...
app = modal.App("naadify-music-generator")

# Define the Docker image with the necessary dependencies
image = (
...
# Define the volumes for model storage and Hugging Face cache
...
class MusicGenServer:
    ...
    def generate(self) -> GenerateMusicResponse:
        ...
        self.music_model(
            prompt="electronic rap, new-york, joyful, 120BPM",
